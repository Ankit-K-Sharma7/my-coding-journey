...
def remove_suffix_ness(word):
    ...
    """
    stripped_word = word[:-4]

    if stripped_word[-1] == "i":
        new_word = stripped_word.strip("i") + "y"
    else:
        new_word = stripped_word
...
def adjective_to_verb(sentence, index):
    ...
    if splitted_words[index][-1] == ".":
        verbified_sentence = splitted_words[index][:-1] + "en"
    else:
        verbified_sentence = splitted_words[index] + "en"

    return verbified_sentence
